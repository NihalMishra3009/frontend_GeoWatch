    ...
    <div id="home" className="space-y-12">
      ...
      <section className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-700 p-10 text-white shadow-lg">
        ...
        <p className="mt-4 text-slate-200">
          GeoWatch is a geofence-enabled crowd risk intelligence system for large public events.
        </p>
      ...
      <section id="mobile-app" className="rounded-2xl border p-8 bg-white">
        ...
        <p className="mt-3 text-slate-600">
          Download the Android app to report incidents instantly.
        </p>
      ...
      <footer className="rounded-2xl bg-slate-900 p-8 text-white">
        © 2026 GeoWatch
      </footer>
    </div>
  );
